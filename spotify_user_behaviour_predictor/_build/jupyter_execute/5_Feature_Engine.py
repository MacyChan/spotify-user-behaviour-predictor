...
# 2. Extract song lyric using Genius API (Python) [Here](https://github.com/MacyChan/MacyResumeWebpage-public/blob/main/springboot/src/main/java/com/macydevelopment/springboot/service/SpotifyQueryArtistService.java)
